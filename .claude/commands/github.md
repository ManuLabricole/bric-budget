...
> Cette commande n'est qu'un point d'entrée manuel : la convention 5-axes v2 (epic=foyer,
> milestone=release planifiée), les templates issue/PR et le cycle 1 issue = 1 branche = 1 PR
> vivent dans le skill (pas de duplication).
...
toute issue = **epic (foyer)** + label type + board (milestone seulement si planifié release) ;
PR `--base development` ; Claude ne merge jamais.
